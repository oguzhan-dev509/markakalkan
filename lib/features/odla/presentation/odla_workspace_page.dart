...
class _OperationalWorkspace extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final sections = <Widget>[
      ...
      _OperationalSection(
        title: 'Numune & Mühür Bütünlüğü',
        description:
            'Her numunenin bağımsız delil zinciri, mühür geçmişi, hash/sıra/öncül bütünlüğü ve test bağlantıları salt okunur olarak özetlenir.',
        icon: Icons.inventory_2_outlined,
        count: detail.custodyIntegrityContext.samples.length,
        emptyText: 'Bu vakada henüz numune bütünlüğü bağlamı oluşturulmamış.',
        records: detail.custodyIntegrityContext.samples
            .map(
              (sample) => _RecordView(
                title: 'Numune ${_shortId(sample.sampleId)}',
                subtitle: [
                  '${sample.eventCount} olay',
                  if (sample.currentSealId != null)
                    'Mühür ${_shortId(sample.currentSealId!)}',
                  sample.integrityStatus,
                ].join(' • '),
                state: sample.integrityStatus,
                rows: _displayRows(sample.raw, const [
                  'sampleId',
                  'eventCount',
                  'latestEventId',
                  'latestEventSequence',
...
String _fieldLabel(String key) {
  const labels = <String, String>{
    ...
    'eventType': 'Olay türü',
    'sampleId': 'Numune',
    'eventCount': 'Zincir olayı sayısı',
    'latestEventId': 'Son zincir olayı',
    'latestEventSequence': 'Son sıra',
    'currentSealId': 'Güncel mühür',
    'sealIds': 'Mühür geçmişi',
    'sealChangeCount': 'Mühür değişimi',
    'openingEventCount': 'Açma olayı',
    'hasSealChange': 'Mühür değişti',
    'appendOnlyStatus': 'Append-only durumu',
    'integrityStatus': 'Zincir bütünlüğü',
    'integrityCode': 'Bütünlük kodu',
    'hashIntegrityStatus': 'Hash bütünlüğü',
    'sequenceIntegrityStatus': 'Sıra bütünlüğü',
    'predecessorIntegrityStatus': 'Öncül bağlantısı',
    'evidenceReferenceCount': 'Delil referansı sayısı',
    'testRequestIds': 'Test talepleri',
    'testResultIds': 'Test sonuçları',
    'appealIds': 'İtirazlar',
    'testResultIntegritySummary': 'Test sonucu bütünlük özeti',
