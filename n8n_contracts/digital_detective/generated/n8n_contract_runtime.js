  ...
  var require_context_validation = __commonJS({
    "validators/context_validation.js"(exports, module) {
      ...
      function readValidationContext(value, {
        ...
        const candidateEntries = candidates ? readOwnDataProperty(value, "candidates") : { kind: "absent" };
        const evidenceEntries = evidences ? readOwnDataProperty(value, "evidences") : { kind: "absent" };
        const callback = readOwnDataProperty(value, "productionCallback");
        if (taskId.kind !== "data" || typeof taskId.value !== "string" || !taskId.value || executionId.kind !== "data" || typeof executionId.value !== "string" || !executionId.value || candidates && (candidateEntries.kind !== "data" || !Array.isArray(candidateEntries.value)) || evidences && (evidenceEntries.kind !== "data" || !Array.isArray(evidenceEntries.value)) || callback.kind === "invalid") {
          return null;
        }
      ...
      function candidateEntryValid(candidate) {
        ...
        return sourceId.kind === "data" && nonEmptyString(sourceId.value) && taskId.kind === "data" && nonEmptyString(taskId.value) && executionId.kind === "data" && nonEmptyString(executionId.value) && acquisitionStatus.kind === "data" && nonEmptyString(acquisitionStatus.value) && canonicalUrl.kind !== "invalid" && sourceUrl.kind !== "invalid" && (canonicalUrl.kind === "data" && nonEmptyString(canonicalUrl.value) || sourceUrl.kind === "data" && nonEmptyString(sourceUrl.value));
      }
      function evidenceEntryValid(evidence) {
        ...
        return sourceId.kind === "data" && nonEmptyString(sourceId.value) && taskId.kind === "data" && nonEmptyString(taskId.value) && executionId.kind === "data" && nonEmptyString(executionId.value) && acquisitionStatus.kind === "data" && nonEmptyString(acquisitionStatus.value) && snapshotId.kind === "data" && (typeof snapshotId.value === "string" || snapshotId.value === null) && sourceUrl.kind === "data" && nonEmptyString(sourceUrl.value);
      }
